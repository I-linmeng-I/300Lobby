...
function Init_MenuListpart(wnd)
	...
	--扫雷
	bk_switch1 = g_up:AddButton(path_lolcard.."kaiguan1.BMP",path_lolcard.."kaiguan2.BMP",path_lolcard.."kaiguan3.BMP",126,730-OffsetY1,69,70)	
	bk_switch1.script[XE_LBUP] = function()
		XClickPlaySound(UI_click_new)
		if saolei_BKWND:IsVisible()==true then
	...
	--切换壁纸
	Btn_turn = g_up:AddButton("../data/wallpaper/l.bmp","../data/wallpaper/l1.bmp","../data/wallpaper/l2.bmp",189,730-OffsetY1,69,70)
	local time = 1
	Btn_turn.script[XE_LBUP] = function()
	     if btn_taaa ~= nil then
		 btn_taaa.changeimage("../data/wallpaper/"..time..".bmp")
         time=time+1
          if time==30 then
            time=1
          end
